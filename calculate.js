function calculatepoints() {
    ...
    if(koianswer.checked) {
        koicorr.style.display="block";
        koiincorr.style.display="none";
        koiright.style.display="block";
        koiwrong.style.display="none";
        aa = 13;
    }else {
        koicorr.style.display="none";
        koiincorr.style.display="block";
        koiright.style.display="none";
        koiwrong.style.display="block";
        aa = 0;
    }
    
    if(banjoanswer.checked) {
        banjocorr.style.display="block";
        banjoincorr.style.display="none";
        banjoright.style.display="block";
        banjowrong.style.display="none";
        ab = 13;
    }else {
        banjocorr.style.display="none";
        banjoincorr.style.display="block";
        banjoright.style.display="none";
        banjowrong.style.display="block";
        ab = 0;
    }
    
    if(hand13answer.checked) {
        hand13corr.style.display="block";
        hand13incorr.style.display="none";
        hand13right.style.display="block";
        hand13wrong.style.display="none";
        ac = 4;
    }else {
        hand13corr.style.display="none";
        hand13incorr.style.display="block";
        hand13right.style.display="none";
        hand13wrong.style.display="block";
        ac = 0;
    }
    
    if(armlyricsanswer.checked) {
        armlyricscorr.style.display="block";
        armlyricsincorr.style.display="none";
        armlyricsright.style.display="block";
        armlyricswrong.style.display="none";
        ad = 5;
    }else {
        armlyricscorr.style.display="none";
        armlyricsincorr.style.display="block";
        armlyricsright.style.display="none";
        armlyricswrong.style.display="block";
        ad = 0;
    }
    
    if(additionalsnanswer.checked) {
        additionalsncorr.style.display="block";
        additionalsnincorr.style.display="none";
        additionalsnright.style.display="block";
        additionalsnwrong.style.display="none";
        ae = 5;
    }else {
        additionalsncorr.style.display="none";
        additionalsnincorr.style.display="block";
        additionalsnright.style.display="none";
        additionalsnwrong.style.display="block";
        ae = 0;
    }
    
    if(snvaulttrackanswer.checked) {
        snvaulttrackcorr.style.display="block";
        snvaulttrackincorr.style.display="none";
        snvaulttrackright.style.display="block";
        snvaulttrackwrong.style.display="none";
        af =5;
    }else {
        snvaulttrackcorr.style.display="none";
        snvaulttrackincorr.style.display="block";
        snvaulttrackright.style.display="none";
        snvaulttrackwrong.style.display="block";
        af = 0;
    }
    
    let x = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v + w + aa + ab + ac + ad + ae + af; document.getElementById("total-points").innerHTML = x;
    if(x>78.5){
